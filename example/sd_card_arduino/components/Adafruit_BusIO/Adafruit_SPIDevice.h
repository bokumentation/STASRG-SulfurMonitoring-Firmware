...
// some modern SPI definitions don't have BitOrder enum
    ...
    defined(SPARK) || defined(ARDUINO_ARCH_SPRESENSE) || defined(MEGATINYCORE) || defined(DXCORE) ||                   \
    defined(ARDUINO_AVR_ATmega4809) || defined(ARDUINO_AVR_ATmega4808) || defined(ARDUINO_AVR_ATmega3209) ||           \
    defined(ARDUINO_AVR_ATmega3208) || defined(ARDUINO_AVR_ATmega1609) || defined(ARDUINO_AVR_ATmega1608) ||           \
    defined(ARDUINO_AVR_ATmega809) || defined(ARDUINO_AVR_ATmega808) || defined(ARDUINO_ARCH_ARC32) ||                 \
...
#elif (defined(__arm__) || defined(ARDUINO_FEATHER52)) && !defined(ARDUINO_ARCH_RP2040) && !defined(ARDUINO_SILABS) && \
...
public:
    ...
    Adafruit_SPIDevice(int8_t cspin, uint32_t freq = 1000000, BusIOBitOrder dataOrder = SPI_BITORDER_MSBFIRST,
    ...
    bool write_then_read(const uint8_t *write_buffer, size_t write_len, uint8_t *read_buffer, size_t read_len,
