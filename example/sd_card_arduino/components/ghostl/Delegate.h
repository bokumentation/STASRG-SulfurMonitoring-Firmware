#pragma once
/*
Delegate.h - An efficient interchangeable C function ptr and C++ std::function
delegate Copyright (c) 2019 Dirk O. Kaar. All rights reserved.
...
template <typename R, typename... P> ALWAYS_INLINE_ATTR inline R IRAM_ATTR vPtrToFunPtrExec(void *fn, P... args)
{
...
#if !defined(ARDUINO) || defined(ESP8266) || defined(ESP32)
template <typename A, typename R, typename... P> class DelegatePImpl {
public:
    using target_type = R(P...);
...
public:
    ...
    static inline R IRAM_ATTR vPtrToFunAPtrExec(void *self, P... args) ALWAYS_INLINE_ATTR {
        return static_cast<DelegatePImpl *>(self)->fnA(static_cast<DelegatePImpl *>(self)->obj,
                                                       std::forward<P...>(args...));
    };
...
#if !defined(ARDUINO) || defined(ESP8266) || defined(ESP32)
template <typename R, typename... P> class DelegatePImpl<void, R, P...> {
public:
    using target_type = R(P...);
...
#if !defined(ARDUINO) || defined(ESP8266) || defined(ESP32)
template <typename A, typename R> class DelegateImpl {
public:
    using target_type = R();
...
public:
    ...
    static inline R IRAM_ATTR vPtrToFunAPtrExec(void *self) ALWAYS_INLINE_ATTR {
        return static_cast<DelegateImpl *>(self)->fnA(static_cast<DelegateImpl *>(self)->obj);
    };
    ...
    operator FunVPPtr() const
    {
        if (FP == kind) {
            ...
            return [](void *self) -> R { return static_cast<DelegateImpl *>(self)->functional(); };
        }
    }
...
#if !defined(ARDUINO) || defined(ESP8266) || defined(ESP32)
template <typename R> class DelegateImpl<void, R> {
public:
    using target_type = R();
...
public:
    ...
    {
        return detail::DelegatePImpl<A, R, P...>::operator FunctionType();
    }
#endif
    ...
    Delegate(const Delegate &del)
        : detail::DelegatePImpl<A, R, P...>::DelegatePImpl(
    ...
    template <typename F>
    Delegate(F functional) : detail::DelegatePImpl<A, R, P...>::DelegatePImpl(std::forward<F>(functional))
    {
    }
...
template <typename R, typename... P> class Delegate<void, R, P...> : private detail::DelegatePImpl<void, R, P...> {
public:
    using target_type = R(P...);
...
public:
    ...
    operator FunVPPtr() const
    {
        return detail::DelegatePImpl<void, R, P...>::operator FunVPPtr();
    }
#if !defined(ARDUINO) || defined(ESP8266) || defined(ESP32)
    operator FunctionType()
    {
        return detail::DelegatePImpl<void, R, P...>::operator FunctionType();
    }
#endif
    ...
    Delegate(const Delegate &del)
        : detail::DelegatePImpl<void, R, P...>::DelegatePImpl(
    ...
    template <typename F>
    Delegate(F functional) : detail::DelegatePImpl<void, R, P...>::DelegatePImpl(std::forward<F>(functional))
    {
    }
...
template <typename A, typename R> class Delegate<A, R> : private detail::DelegateImpl<A, R> {
public:
    using target_type = R();
...
public:
    ...
    operator FunctionType()
    {
        return detail::DelegateImpl<A, R>::operator FunctionType();
    }
#endif
    ...
    Delegate(const Delegate &del)
        : detail::DelegateImpl<A, R>::DelegateImpl(static_cast<const detail::DelegateImpl<A, R> &>(del))
    {
    }

    Delegate(Delegate &&del)
        : detail::DelegateImpl<A, R>::DelegateImpl(std::move(static_cast<detail::DelegateImpl<A, R> &>(del)))
    {
    }
    ...
    template <typename F>
    Delegate(F functional) : detail::DelegateImpl<A, R>::DelegateImpl(std::forward<F>(functional))
    {
    }
...
template <typename R> class Delegate<void, R> : private detail::DelegateImpl<void, R> {
public:
    using target_type = R();
...
public:
    ...
    operator FunVPPtr() const
    {
        return detail::DelegateImpl<void, R>::operator FunVPPtr();
    }
#if !defined(ARDUINO) || defined(ESP8266) || defined(ESP32)
    operator FunctionType()
    {
        return detail::DelegateImpl<void, R>::operator FunctionType();
    }
#endif
    ...
    Delegate(const Delegate &del)
        : detail::DelegateImpl<void, R>::DelegateImpl(static_cast<const detail::DelegateImpl<void, R> &>(del))
    {
    }

    Delegate(Delegate &&del)
        : detail::DelegateImpl<void, R>::DelegateImpl(std::move(static_cast<detail::DelegateImpl<void, R> &>(del)))
    {
    }
    ...
    template <typename F>
    Delegate(F functional) : detail::DelegateImpl<void, R>::DelegateImpl(std::forward<F>(functional))
    {
    }
...
template <typename A, typename R, typename... P>
class Delegate<R(P...), A> : public delegate::detail::Delegate<A, R, P...> {
public:
    ...
    Delegate(typename delegate::detail::Delegate<A, R, P...>::FunAPtr fnA, const A &obj)
        : delegate::detail::Delegate<A, R, P...>::Delegate(fnA, obj)
    {
    }

    Delegate(typename delegate::detail::Delegate<A, R, P...>::FunAPtr fnA, A &&obj)
        : delegate::detail::Delegate<A, R, P...>::Delegate(fnA, std::move(obj))
    {
    }

    Delegate(typename delegate::detail::Delegate<A, R, P...>::FunPtr fn)
        : delegate::detail::Delegate<A, R, P...>::Delegate(fn)
    {
    }

    template <typename F>
    Delegate(F functional) : delegate::detail::Delegate<A, R, P...>::Delegate(std::forward<F>(functional))
    {
    }
...
public:
    ...
    Delegate(const Delegate &del)
        : delegate::detail::Delegate<void, R, P...>::Delegate(
    ...
    Delegate(typename delegate::detail::Delegate<void, R, P...>::FunPtr fn)
        : delegate::detail::Delegate<void, R, P...>::Delegate(fn)
    {
    }

    template <typename F>
    Delegate(F functional) : delegate::detail::Delegate<void, R, P...>::Delegate(std::forward<F>(functional))
    {
    }
