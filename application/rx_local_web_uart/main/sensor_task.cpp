...
// karena data ini diakses oleh beberapa task (sensor_reading, anemometer_task,
// batteryTask)
...
void sensor_reading(void *pvParameters)
{
    ...
    while (1) {
        ...
        // live_data.h2s_ppm = tb600b_convert_ugm3_to_ppm(h2s_data.gas_ugm3,
        // h2s_data.temperature_c, M_W_H2S); // H2S: 34.08 g/mol live_data.h2s_ugm =
        // h2s_data.gas_ugm3;

        // live_data.so2_ppm = tb600b_convert_ugm3_to_ppm(so2_data.gas_ugm3,
        // so2_data.temperature_c, M_W_SO2); // SO2: 64.06 g/mol live_data.so2_ugm =
        // so2_data.gas_ugm3;
