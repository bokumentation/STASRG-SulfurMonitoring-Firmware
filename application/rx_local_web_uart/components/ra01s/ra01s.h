...
#define SX126X_SLEEP_START_COLD 0b00000000 //  2     2     sleep mode: cold start, configuration is lost
//  (default)
...
#define SX126X_GFSK_PREAMBLE_DETECT_OFF 0x00 //  7     0     GFSK minimum preamble length before reception starts:
//  detector disabled
#define SX126X_GFSK_PREAMBLE_DETECT_8 0x04 //  7     0                                                           8
//  bits
#define SX126X_GFSK_PREAMBLE_DETECT_16 0x05 //  7     0                                                           16
//  bits
#define SX126X_GFSK_PREAMBLE_DETECT_24 0x06 //  7     0                                                           24
//  bits
#define SX126X_GFSK_PREAMBLE_DETECT_32 0x07 //  7     0                                                           32
//  bits
...
#define SX126X_GFSK_PACKET_FIXED 0x00 //  7     0     GFSK packet type: fixed (payload length known in advance
//  to both sides)
#define SX126X_GFSK_PACKET_VARIABLE 0x01 //  7     0                       variable (payload length added to
//  packet)
...
#define SX126X_STATUS_DATA_AVAILABLE 0b00000100  //  3     1     command status: packet received and data can be
//  retrieved
