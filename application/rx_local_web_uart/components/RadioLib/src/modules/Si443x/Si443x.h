...
#define RADIOLIB_SI443X_FREQUENCY_ERROR 0b00001000      //  3     3   frequency error flag (frequency outside allowed
//  range)
...
#define RADIOLIB_SI443X_FIFO_LEVEL_ERROR_ENABLED                                                                       \
    0b10000000 //  7     7   Tx/Rx FIFO overflow or underflow interrupt enabled
...
#define RADIOLIB_SI443X_ANT_DIV_TR_HL_IDLE_L 0b00000000 //  7     5   GPIO1/2 states: Tx/Rx GPIO1 H, GPIO2 L; idle low
//  (default)
...
#define RADIOLIB_SI443X_ANT_DIV_TR_ALG_IDLE_L                                                                          \
    0b10000000 //  7     5                   Tx/Rx diversity algorithm; idle low
#define RADIOLIB_SI443X_ANT_DIV_TR_ALG_IDLE_H                                                                          \
    0b10100000 //  7     5                   Tx/Rx diversity algorithm; idle high
#define RADIOLIB_SI443X_ANT_DIV_TR_ALG_BEACON_IDLE_L                                                                   \
    0b11000000 //  7     5                   Tx/Rx diversity algorithm (beacon);
//  idle low
#define RADIOLIB_SI443X_ANT_DIV_TR_ALG_BEACON_IDLE_H                                                                   \
    0b11100000 //  7     5                   Tx/Rx diversity algorithm (beacon);
//  idle high
...
#define RADIOLIB_SI443X_AUTO_TX_OFF 0b00000000        //  3     3   Tx autotransmit on FIFO almost full: disabled
//  (default)
...
#define RADIOLIB_SI443X_XTAL_LOAD_CAPACITANCE 0b01111111 //  6     0     C_int = 1.8 pF + 0.085 pF *
//  RADIOLIB_SI443X_XTAL_LOAD_CAPACITANCE + 3.7 pF *
//  RADIOLIB_SI443X_XTAL_SHIFT
...
// RADIOLIB_SI443X_REG_GPIO0_CONFIG + RADIOLIB_SI443X_REG_GPIO1_CONFIG +
// RADIOLIB_SI443X_REG_GPIO2_CONFIG
#define RADIOLIB_SI443X_GPIOX_DRIVE_STRENGTH                                                                           \
    0b00000000                                      //  7     6   GPIOx drive strength (higher number = stronger drive)
...
#define RADIOLIB_SI443X_GPIO0_POWER_ON_RESET_OUT                                                                       \
    0b00000000 //  4     0   GPIOx function: power-on-reset output (GPIO0 only,
//  default)
#define RADIOLIB_SI443X_GPIO1_POWER_ON_RESET_INV_OUT                                                                   \
    0b00000000 //  4     0                   inverted power-on-reset output (GPIO1
//  only, default)
#define RADIOLIB_SI443X_GPIO2_MCU_CLOCK_OUT 0b00000000 //  4     0                   MCU clock output (GPIO2 only,
//  default)
...
#define RADIOLIB_SI443X_GPIOX_EXT_INT_FALLING_IN                                                                       \
    0b00000100 //  4     0                   external interrupt, falling edge
#define RADIOLIB_SI443X_GPIOX_EXT_INT_RISING_IN 0b00000101 //  4     0                   external interrupt, rising edge
#define RADIOLIB_SI443X_GPIOX_EXT_INT_CHANGE_IN                                                                        \
    0b00000110                                            //  4     0                   external interrupt, state change
...
#define RADIOLIB_SI443X_GPIOX_TX_RX_DATA_CLK_OUT                                                                       \
    0b00001111                                      //  4     0                   Tx/Rx clock output in direct mode
#define RADIOLIB_SI443X_GPIOX_TX_DATA_IN 0b00010000 //  4     0                   Tx data input direct mode
#define RADIOLIB_SI443X_GPIOX_EXT_RETRANSMIT_REQUEST_IN                                                                \
    0b00010001 //  4     0                   external retransmission request input
#define RADIOLIB_SI443X_GPIOX_TX_STATE_OUT 0b00010010 //  4     0                   Tx state output
#define RADIOLIB_SI443X_GPIOX_TX_FIFO_ALMOST_FULL_OUT                                                                  \
    0b00010011                                        //  4     0                   Tx FIFO almost full output
...
#define RADIOLIB_SI443X_GPIOX_RX_FIFO_ALMOST_FULL_OUT                                                                  \
    0b00010110                                              //  4     0                   Rx FIFO almost full output
...
#define RADIOLIB_SI443X_GPIOX_INVALID_PREAMBLE_OUT                                                                     \
    0b00011010 //  4     0                   invalid preamble detected output
...
#define RADIOLIB_SI443X_ADC_SOURCE_TEMPERATURE                                                                         \
    0b00000000 //  6     4   ADC source: internal temperature sensor (default)
...
#define RADIOLIB_SI443X_ADC_SOURCE_GPIO01_DIFF                                                                         \
    0b01000000 //  6     4               differential on GPIO0 (+) and GPIO1 (-)
#define RADIOLIB_SI443X_ADC_SOURCE_GPIO12_DIFF                                                                         \
    0b01010000 //  6     4               differential on GPIO1 (+) and GPIO2 (-)
#define RADIOLIB_SI443X_ADC_SOURCE_GPIO02_DIFF                                                                         \
    0b01100000                                    //  6     4               differential on GPIO0 (+) and GPIO2 (-)
...
#define RADIOLIB_SI443X_TEMP_SENSOR_RANGE_64_TO_64_C                                                                   \
    0b00000000 //  7     6   temperature sensor range: -64 to 64 deg. C, 0.5 deg.
//  C resolution (default)
#define RADIOLIB_SI443X_TEMP_SENSOR_RANGE_64_TO_192_C                                                                  \
    0b01000000 //  7     6                             -64 to 192 deg. C, 1.0 deg.
//  C resolution
#define RADIOLIB_SI443X_TEMP_SENSOR_RANGE_0_TO_128_C                                                                   \
    0b11000000 //  7     6                             0 to 128 deg. C, 0.5 deg. C
//  resolution
#define RADIOLIB_SI443X_TEMP_SENSOR_RANGE_40_TO_216_F                                                                  \
    0b10000000 //  7     6                             -40 to 216 deg. F, 1.0 deg.
//  F resolution
#define RADIOLIB_SI443X_TEMP_SENSOR_KELVIN_TO_CELSIUS_OFF 0b00000000 //  5     5   Kelvin to Celsius offset: disabled
#define RADIOLIB_SI443X_TEMP_SENSOR_KELVIN_TO_CELSIUS_ON                                                               \
    0b00100000                                            //  5     5                             enabled (default)
...
// RADIOLIB_SI443X_REG_WAKEUP_TIMER_PERIOD_2 +
// RADIOLIB_SI443X_REG_WAKEUP_TIMER_PERIOD_3
#define RADIOLIB_SI443X_WAKEUP_TIMER_MANTISSA_MSB 0x00 //  7     0   wakeup timer value:
#define RADIOLIB_SI443X_WAKEUP_TIMER_MANTISSA_LSB                                                                      \
    0x01 //  7     0     T = (4 * RADIOLIB_SI443X_WAKEUP_TIMER_MANTISSA * 2 ^
//  RADIOLIB_SI443X_WAKEUP_TIMER_EXPONENT) / 32.768 ms

// RADIOLIB_SI443X_REG_LOW_DC_MODE_DURATION
#define RADIOLIB_SI443X_LOW_DC_MODE_DURATION_MANTISSA 0x01 //  7     0   low duty cycle mode duration: T = (4 *
//  RADIOLIB_SI443X_LOW_DC_MODE_DURATION_MANTISSA * 2 ^
//  RADIOLIB_SI443X_WAKEUP_TIMER_EXPONENT) / 32.768 ms

// RADIOLIB_SI443X_REG_LOW_BATT_DET_THRESHOLD
#define RADIOLIB_SI443X_LOW_BATT_DET_THRESHOLD 0b00010100 //  4     0   low battery detection threshold: Vth = 1.7 +
//  RADIOLIB_SI443X_LOW_BATT_DET_THRESHOLD * 0.05 V (defaults
//  to 2.7 V)
...
#define RADIOLIB_SI443X_SECOND_PHASE_BIAS_0_DB                                                                         \
    0b00000100 //  2     2   second phase antenna selection bias: 0 dB (default)
...
#define RADIOLIB_SI443X_MOVING_AVERAGE_TAP_4 0b00000000 //  1     1                                     4*Tb after first
//  preamble (default)
#define RADIOLIB_SI443X_ZERO_PHASE_RESET_5 0b00000000 //  0     0   reset preamble detector after: 5 zero phases
//  (default)
#define RADIOLIB_SI443X_ZERO_PHASE_RESET_2 0b00000001 //  0     0                                  3 zero phases

// RADIOLIB_SI443X_REG_AFC_TIMING_CONTROL
#define RADIOLIB_SI443X_SW_ANT_TIMER 0b00000000 //  7     6   number of periods to wait for RSSI to stabilize
...
#define RADIOLIB_SI443X_CLOCK_REC_OVERSAMP_RATIO_LSB                                                                   \
    0b01100100 //  7     0   oversampling rate LSB, defaults to 12.5 clock cycles
//  per bit

// RADIOLIB_SI443X_REG_CLOCK_REC_OFFSET_2
#define RADIOLIB_SI443X_CLOCK_REC_OVERSAMP_RATIO_MSB                                                                   \
    0b00000000 //  7     5   oversampling rate MSB, defaults to 12.5 clock cycles
//  per bit
#define RADIOLIB_SI443X_SECOND_PHASE_SKIP_THRESHOLD                                                                    \
    0b00000000                                    //  4     4   skip seconds phase antenna diversity threshold
...
#define RADIOLIB_SI443X_RX_COMPENSATION_OFF 0b00000000 //  4     4   Rx compensation for high data rate: disabled
//  (default)
#define RADIOLIB_SI443X_RX_COMPENSATION_ON 0b00010000 //  4     4                                       enabled
#define RADIOLIB_SI443X_CLOCK_REC_GAIN_DOUBLE_OFF                                                                      \
    0b00000000 //  3     3   clock recovery gain doubling: disabled (default)
...
#define RADIOLIB_SI443X_OOK_FREEZE_OFF 0b00000000 //  5     5   OOK moving average detector freeze: disabled
//  (default)
...
#define RADIOLIB_SI443X_CRC_DATA_ONLY_OFF 0b00000000      //  5     5   CRC calculated only from data fields: disabled
//  (default)
#define RADIOLIB_SI443X_CRC_DATA_ONLY_ON 0b00100000 //  5     5                                         enabled
#define RADIOLIB_SI443X_SKIP_SECOND_PHASE_PREAMBLE_DET_OFF                                                             \
    0b00000000 //  4     4   skip second phase of preamble detection: disabled
//  (default)
#define RADIOLIB_SI443X_SKIP_SECOND_PHASE_PREAMBLE_DET_ON                                                              \
...
#define RADIOLIB_SI443X_SYNC_WORD_TIMEOUT_OFF                                                                          \
    0b00000000 //  7     7   ignore timeout period when searching for sync word:
//  disabled (default)
...
#define RADIOLIB_SI443X_PREAMBLE_DET_THRESHOLD                                                                         \
    0b00101000 //  7     3   number of 4-bit nibbles in valid preamble, defaults
//  to 20 bits
...
#define RADIOLIB_SI443X_PGA_GAIN_OVERRIDE 0b00000000     //  3     0   PGA gain override, gain =
//  RADIOLIB_SI443X_PGA_GAIN_OVERRIDE * 3 dB
...
#define RADIOLIB_SI443X_OUTPUT_POWER 0b00000000   //  2     0   output power in 3 dB steps, 0 is chip min, 7 is chip
//  max

// RADIOLIB_SI443X_REG_TX_DATA_RATE_1 + RADIOLIB_SI443X_REG_TX_DATA_RATE_0
#define RADIOLIB_SI443X_DATA_RATE_MSB 0x0A //  7     0   data rate: DR = 10^6 * (RADIOLIB_SI443X_DATA_RATE / 2^16)
//  in high data rate mode or
#define RADIOLIB_SI443X_DATA_RATE_LSB 0x3D //  7     0              DR = 10^6 * (RADIOLIB_SI443X_DATA_RATE / 2^21)
//  in low data rate mode (defaults to 40 kbps)
...
#define RADIOLIB_SI443X_PACKET_HANDLER_POWER_DOWN_OFF                                                                  \
    0b00000000 //  4     4   power off packet handler in low power mode: disabled
//  (default)
#define RADIOLIB_SI443X_PACKET_HANDLER_POWER_DOWN_ON                                                                   \
    0b00010000 //  4     4                                               enabled
#define RADIOLIB_SI443X_MANCHESTER_PREAMBLE_POL_LOW 0b00000000 //  3     3   preamble polarity in Manchester mode: low
#define RADIOLIB_SI443X_MANCHESTER_PREAMBLE_POL_HIGH                                                                   \
    0b00001000 //  3     3                                         high (default)
...
#define RADIOLIB_SI443X_FREQUENCY_DEVIATION_LSB 0b00100000 //  7     0   frequency deviation LSB, Fd = 625 Hz *
//  RADIOLIB_SI443X_FREQUENCY_DEVIATION, defaults to 20 kHz

// RADIOLIB_SI443X_REG_FREQUENCY_OFFSET_1 +
// RADIOLIB_SI443X_REG_FREQUENCY_OFFSET_2
#define RADIOLIB_SI443X_FREQUENCY_OFFSET_MSB 0x00 //  7     0   frequency offset:
#define RADIOLIB_SI443X_FREQUENCY_OFFSET_LSB 0x00 //  1     0     Foff = 156.25 Hz * (RADIOLIB_SI443X_BAND_SELECT + 1) *
//  RADIOLIB_SI443X_FREQUENCY_OFFSET, defaults to 156.25 Hz
...
// RADIOLIB_SI443X_REG_NOM_CARRIER_FREQUENCY_1 +
...
#define RADIOLIB_SI443X_NOM_CARRIER_FREQUENCY_LSB 0b10000000 //  7     0     Fc = (RADIOLIB_SI443X_BAND_SELECT +
//  1)*10*(RADIOLIB_SI443X_FREQUENCY_BAND_SELECT + 24) +
//  (RADIOLIB_SI443X_NOM_CARRIER_FREQUENCY -
//  RADIOLIB_SI443X_FREQUENCY_OFFSET)/6400 [MHz]
...
/*!
  \class Si443x
  \brief Base class for Si443x series. All derived classes for Si443x (e.g.
  Si4431 or Si4432) inherit from this base class. This class should not be
...
public:
    ...
    */
    ...
    /*!
      \brief Binary transmit method. Will transmit arbitrary binary data up to 64
      bytes long. For overloads to transmit Arduino String or C-string, see
    ...
    */
    ...
    /*!
      ...
      up to 64 bytes long. For overloads to receive Arduino String, see
      PhysicalLayer::receive. \param data Pointer to array to save the received
      binary data. \param len Number of bytes that will be received. Must be known
      in advance for binary transmissions. \param timeout Reception timeout in
      milliseconds. If set to 0, timeout period will be calculated automatically
      based on the radio configuration. \returns \ref status_codes
    */
    int16_t receive(uint8_t *data, size_t len, RadioLibTime_t timeout = 0) override;

    /*!
      \brief Sets the module to sleep to save power. %Module will not be able to
      transmit or receive any data while in sleep mode. %Module will wake up
      automatically when methods like transmit or receive are called. \returns
      \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Enables direct transmission mode. While in direct mode, the module
      will not be able to transmit or receive packets. \param frf 24-bit raw
    ...
    */
    ...
    /*!
      \brief Enables direct reception mode. While in direct mode, the module will
      not be able to transmit or receive packets. \returns \ref status_codes
    */
    int16_t receiveDirect() override;

    /*!
      \brief Disables direct mode and enables packet mode, allowing the module to
      receive packets. \returns \ref status_codes
    */
    int16_t packetMode();
    ...
    */
    ...
    /*!
      ...
      arbitrary binary data up to 64 bytes long. \param data Binary data that will
      be transmitted. \param len Length of binary data to transmit (in bytes).
      \param addr Node address to transmit the packet to.
      \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Interrupt-driven receive method. IRQ will be activated when full
      valid packet is received. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      range from 0.625 to 320.0 kHz. \param freqDev Frequency deviation to be set
    ...
    */
    ...
    /*!
      ...
      data shaping. Only available in FSK mode with FSK modulation. Allowed values
      are RADIOLIB_SHAPING_0_5 or RADIOLIB_SHAPING_1_0. Set to
    ...
    */
    ...
    /*!
     \brief Read version SPI register. Should return
     RADIOLIB_SI443X_DEVICE_VERSION (0x06) if Si443x is connected and working.
