...
#define RADIOLIB_SX126X_SLEEP_START_COLD 0b00000000 //  2     2   sleep mode: cold start, configuration is lost
//  (default)
...
#define RADIOLIB_SX126X_RX_TX_FALLBACK_MODE_STDBY_XOSC                                                                 \
    0x30 //  7     0                      standby with crystal oscillator
#define RADIOLIB_SX126X_RX_TX_FALLBACK_MODE_STDBY_RC                                                                   \
...
//  detector disabled
#define RADIOLIB_SX126X_GFSK_PREAMBLE_DETECT_8                                                                         \
    0x04 //  7     0                                                         8
//  bits
#define RADIOLIB_SX126X_GFSK_PREAMBLE_DETECT_16                                                                        \
    0x05 //  7     0                                                         16
//  bits
#define RADIOLIB_SX126X_GFSK_PREAMBLE_DETECT_24                                                                        \
    0x06 //  7     0                                                         24
//  bits
#define RADIOLIB_SX126X_GFSK_PREAMBLE_DETECT_32                                                                        \
    0x07 //  7     0                                                         32
//  bits
...
#define RADIOLIB_SX126X_GFSK_PACKET_FIXED 0x00 //  7     0   GFSK packet type: fixed (payload length known in advance to
//  both sides)
#define RADIOLIB_SX126X_GFSK_PACKET_VARIABLE                                                                           \
    0x01                                     //  7     0                     variable (payload length added to packet)
...
#define RADIOLIB_SX126X_STATUS_DATA_AVAILABLE 0b00000100  //  3     1   command status: packet received and data can be
//  retrieved
...
// RADIOLIB_SX126X_CMD_SET_LBT_SCAN_PARAMS +
// RADIOLIB_SX126X_CMD_SET_SPECTR_SCAN_PARAMS
