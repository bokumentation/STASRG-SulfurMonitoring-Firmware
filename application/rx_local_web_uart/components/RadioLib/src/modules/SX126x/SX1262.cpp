...
// it was determined by testing in
// https://github.com/jgromes/RadioLib/issues/1628 see also
// https://github.com/radiolib-org/power-tests
static const SX126x::paTableEntry_t paOptTable[32] = {
    {.paDutyCycle = 2, .hpMax = 2, .paVal = -5}, {.paDutyCycle = 2, .hpMax = 1, .paVal = 0},
    {.paDutyCycle = 1, .hpMax = 1, .paVal = 3},  {.paDutyCycle = 1, .hpMax = 2, .paVal = 0},
    {.paDutyCycle = 1, .hpMax = 1, .paVal = 6},  {.paDutyCycle = 1, .hpMax = 2, .paVal = 3},
    {.paDutyCycle = 2, .hpMax = 2, .paVal = 2},  {.paDutyCycle = 4, .hpMax = 1, .paVal = 6},
    {.paDutyCycle = 1, .hpMax = 1, .paVal = 11}, {.paDutyCycle = 2, .hpMax = 1, .paVal = 11},
    {.paDutyCycle = 1, .hpMax = 1, .paVal = 14}, {.paDutyCycle = 2, .hpMax = 1, .paVal = 14},
    {.paDutyCycle = 1, .hpMax = 1, .paVal = 20}, {.paDutyCycle = 1, .hpMax = 1, .paVal = 22},
    {.paDutyCycle = 2, .hpMax = 2, .paVal = 11}, {.paDutyCycle = 3, .hpMax = 1, .paVal = 21},
    {.paDutyCycle = 1, .hpMax = 2, .paVal = 17}, {.paDutyCycle = 4, .hpMax = 2, .paVal = 13},
    {.paDutyCycle = 1, .hpMax = 2, .paVal = 20}, {.paDutyCycle = 1, .hpMax = 2, .paVal = 22},
    {.paDutyCycle = 2, .hpMax = 2, .paVal = 21}, {.paDutyCycle = 3, .hpMax = 2, .paVal = 21},
    {.paDutyCycle = 1, .hpMax = 4, .paVal = 19}, {.paDutyCycle = 1, .hpMax = 4, .paVal = 20},
    {.paDutyCycle = 3, .hpMax = 3, .paVal = 20}, {.paDutyCycle = 2, .hpMax = 5, .paVal = 19},
    {.paDutyCycle = 1, .hpMax = 6, .paVal = 22}, {.paDutyCycle = 2, .hpMax = 5, .paVal = 22},
    {.paDutyCycle = 3, .hpMax = 5, .paVal = 22}, {.paDutyCycle = 3, .hpMax = 6, .paVal = 22},
    {.paDutyCycle = 4, .hpMax = 6, .paVal = 22}, {.paDutyCycle = 4, .hpMax = 7, .paVal = 22},
};
...
int16_t SX1262::begin(float freq, float bw, uint8_t sf, uint8_t cr, uint8_t syncWord, int8_t power,
                      uint16_t preambleLength, float tcxoVoltage, bool useRegulatorLDO)
{
    // execute common part
...
int16_t SX1262::beginFSK(float freq, float br, float freqDev, float rxBw, int8_t power, uint16_t preambleLength,
...
int16_t SX1262::beginLRFHSS(float freq, uint8_t bw, uint8_t cr, bool narrowGrid, int8_t power, float tcxoVoltage,
