...
#define RADIOLIB_CC1101_GDO0_TEMP_SENSOR_OFF                                                                           \
    0b00000000 //  7     7   analog temperature sensor output: disabled (default)
...
#define RADIOLIB_CC1101_GDOX_RX_FIFO_FULL_OR_PKT_END                                                                   \
    0x01                                            //  5     0   Rx FIFO full or above threshold or reached packet end
...
#define RADIOLIB_CC1101_GDOX_CLOCK_XOSC_192 0x3F //  5     0                             f = f(XOSC)/192 (default for
//  GDO0)
...
#define RADIOLIB_CC1101_CRC_AUTOFLUSH_OFF 0b00000000 //  3     3   automatic Rx FIFO flush on CRC check fail: disabled
//  (default)
...
#define RADIOLIB_CC1101_ADR_CHK_DOUBLE_BROADCAST                                                                       \
    0b00000011 //  1     0                  broadcast addresses 0x00 and 0xFF
...
#define RADIOLIB_CC1101_FREQ_IF 0x0F //  4     0   IF frequency setting; f_IF = (f(XOSC) / 2^10) *
//  CC1101_FREQ_IF
...
#define RADIOLIB_CC1101_CHANBW_E 0b10000000 //  7     6   channel bandwidth: BW_channel = f(XOSC) / (8 * (4 +
//  CHANBW_M)*2^CHANBW_E) [Hz]
#define RADIOLIB_CC1101_CHANBW_M 0b00000000 //  5     4       default value for 26 MHz crystal: 203 125 Hz
#define RADIOLIB_CC1101_DRATE_E 0x0C        //  3     0   symbol rate: R_data = (((256 + DRATE_M) * 2^DRATE_E) /
//  2^28) * f(XOSC) [Baud]
...
#define RADIOLIB_CC1101_DEM_DCFILT_ON 0b00000000  //  7     7                      enabled - only for data rates
//  above 250 kBaud (default)
...
#define RADIOLIB_CC1101_MOD_FORMAT_MFSK 0b01110000    //  6     4                      MFSK - only for data rates above
//  26 kBaud
...
#define RADIOLIB_CC1101_SYNC_MODE_NONE_THR 0b00000100 //  2     0                    no preamble sync, carrier sense
//  above threshold
#define RADIOLIB_CC1101_SYNC_MODE_15_16_THR                                                                            \
    0b00000101 //  2     0                    15/16 sync word bits, carrier sense
//  above threshold
#define RADIOLIB_CC1101_SYNC_MODE_16_16_THR                                                                            \
    0b00000110 //  2     0                    16/16 sync word bits, carrier sense
//  above threshold
#define RADIOLIB_CC1101_SYNC_MODE_30_32_THR                                                                            \
    0b00000111 //  2     0                    30/32 sync word bits, carrier sense
//  above threshold

// RADIOLIB_CC1101_REG_MDMCFG1
#define RADIOLIB_CC1101_FEC_OFF 0b00000000 //  7     7   forward error correction: disabled (default)
#define RADIOLIB_CC1101_FEC_ON 0b10000000  //  7     7                             enabled - only for fixed
//  packet length
...
#define RADIOLIB_CC1101_CHANSPC_E 0x02             //  1     0   channel spacing: df_channel = (f(XOSC) / 2^18) * (256 +
//  CHANSPC_M) * 2^CHANSPC_E [Hz]
...
#define RADIOLIB_CC1101_DEVIATION_E 0b01000000 //  6     4   frequency deviation: f_dev = (f(XOSC) / 2^17) * (8 +
//  DEVIATION_M) * 2^DEVIATION_E [Hz]
#define RADIOLIB_CC1101_DEVIATION_M 0b00000111       //  2     0       default value for 26 MHz crystal: +- 47 607 Hz
#define RADIOLIB_CC1101_MSK_PHASE_CHANGE_PERIOD 0x07 //  2     0   phase change symbol period fraction: 1 /
//  (MSK_PHASE_CHANGE_PERIOD + 1)
...
#define RADIOLIB_CC1101_RX_TIMEOUT_MAX 0b00000000      //  2     0               max value (actual value depends on
//  WOR_RES, EVENT0 and f(XOSC))
...
#define RADIOLIB_CC1101_CCA_MODE_RSSI_THR_RX_PKT                                                                       \
    0b00110000 //  5     4                             RSSI below threshold unless
//  receiving packet (default)
...
#define RADIOLIB_CC1101_FS_AUTOCAL_IDLE_TO_RXTX                                                                        \
    0b00010000 //  5     4                          every transition from idle to
//  Rx/Tx
#define RADIOLIB_CC1101_FS_AUTOCAL_RXTX_TO_IDLE                                                                        \
    0b00100000 //  5     4                          every transition from Rx/Tx to
//  idle
#define RADIOLIB_CC1101_FS_AUTOCAL_RXTX_TO_IDLE_4TH                                                                    \
    0b00110000 //  5     4                          every 4th transition from
//  Rx/Tx to idle
#define RADIOLIB_CC1101_PO_TIMEOUT_COUNT_1 0b00000000 //  3     2   number of counter expirations before CHP_RDYN goes
//  low: 1 (default)
...
#define RADIOLIB_CC1101_FOC_BS_CS_GATE_OFF 0b00000000 //  5     5   do not freeze frequency compensation until CS goes
//  high
#define RADIOLIB_CC1101_FOC_BS_CS_GATE_ON 0b00100000 //  5     5   freeze frequency compensation until CS goes high
//  (default)
...
#define RADIOLIB_CC1101_FOC_PRE_3K 0b00010000 //  4     3                                                      3K
//  (default)
#define RADIOLIB_CC1101_FOC_PRE_4K 0b00011000 //  4     3                                                      4K
#define RADIOLIB_CC1101_FOC_POST_K 0b00000000 //  2     2   frequency compensation loop gain after sync word:
//  same as FOC_PRE
#define RADIOLIB_CC1101_FOC_POST_K_2 0b00000100 //  2     2                                                     K/2
//  (default)
#define RADIOLIB_CC1101_FOC_LIMIT_NO_COMPENSATION 0b00000000 //  1     0   frequency compensation saturation point: no
//  compensation - required for ASK/OOK
#define RADIOLIB_CC1101_FOC_LIMIT_BW_CHAN_8                                                                            \
    0b00000001 //  1     0                                            +- BW_chan/8
#define RADIOLIB_CC1101_FOC_LIMIT_BW_CHAN_4                                                                            \
    0b00000010 //  1     0                                            +- BW_chan/4
//  (default)
#define RADIOLIB_CC1101_FOC_LIMIT_BW_CHAN_2                                                                            \
    0b00000011 //  1     0                                            +- BW_chan/2
...
#define RADIOLIB_CC1101_BS_PRE_2KI 0b01000000 //  7     6                                                  2Ki
//  (default)
...
#define RADIOLIB_CC1101_BS_POST_KI 0b00000000 //  3     3   clock recovery integral gain after sync word: same as
//  BS_PRE
#define RADIOLIB_CC1101_BS_POST_KI_2 0b00001000 //  3     3                                                 Ki/2
//  (default)
#define RADIOLIB_CC1101_BS_POST_KP 0b00000000 //  2     2   clock recovery proportional gain after sync word:
//  same as BS_PRE
#define RADIOLIB_CC1101_BS_POST_KP_1 0b00000100 //  2     2                                                     Kp
//  (default)
#define RADIOLIB_CC1101_BS_LIMIT_NO_COMPENSATION 0b00000000 //  1     0   data rate compensation saturation point: no
//  compensation
...
#define RADIOLIB_CC1101_MAX_DVGA_GAIN_0 0b00000000 //  7     6   reduce maximum available DVGA gain: no reduction
//  (default)
#define RADIOLIB_CC1101_MAX_DVGA_GAIN_1 0b01000000 //  7     6                                       disable top gain
//  setting
#define RADIOLIB_CC1101_MAX_DVGA_GAIN_2 0b10000000 //  7     6                                       disable top two
//  gain setting
#define RADIOLIB_CC1101_MAX_DVGA_GAIN_3 0b11000000 //  7     6                                       disable top three
//  gain setting
...
#define RADIOLIB_CC1101_CARRIER_SENSE_REL_THR_OFF 0b00000000 //  5     4   RSSI relative change to assert carrier sense:
//  disabled (default)
#define RADIOLIB_CC1101_CARRIER_SENSE_REL_THR_6_DB                                                                     \
    0b00010000 //  5     4                                                 6 dB
#define RADIOLIB_CC1101_CARRIER_SENSE_REL_THR_10_DB                                                                    \
    0b00100000 //  5     4                                                 10 dB
#define RADIOLIB_CC1101_CARRIER_SENSE_REL_THR_14_DB                                                                    \
    0b00110000 //  5     4                                                 14 dB
#define RADIOLIB_CC1101_CARRIER_SENSE_ABS_THR                                                                          \
    0x00 //  3     0   RSSI threshold to assert carrier sense in 2s compliment,
//  Thr = MAGN_TARGET + CARRIER_SENSE_ABS_TH [dB]
...
#define RADIOLIB_CC1101_AGC_FREEZE_MANUAL_AD                                                                           \
    0b00001100 //  3     2                    manually freeze analog and digital
//  control
#define RADIOLIB_CC1101_FILTER_LENGTH_8 0b00000000  //  1     0   averaging length for channel filter: 8 samples
#define RADIOLIB_CC1101_FILTER_LENGTH_16 0b00000001 //  1     0                                        16 samples
//  (default)
...
#define RADIOLIB_CC1101_EVENT0_TIMEOUT_MSB                                                                             \
    0x87 //  7     0   EVENT0 timeout: t_event0 = (750 / f(XOSC)) * EVENT0_TIMEOUT
//  * 2^(5 * WOR_RES) [s]
...
#define RADIOLIB_CC1101_TEMP_SENS_IDLE_OFF 0x7F //  7     0   temperature sensor will not be available in idle mode
//  (default)
...
#define RADIOLIB_CC1101_DEFAULT_SW                                                                                     \
    { 0x12, 0xAD }
...
public:
    ...
    /*!
      ...
      \param module Instance of Module that will be used to communicate with the
      radio.
    */
    ...
    /*!
      ...
      \param freqDev Frequency deviation from carrier frequency in kHz Defaults
      to 5.0 kHz. \param rxBw Receiver bandwidth in kHz. Defaults to 135.0 kHz.
      \param pwr Output power in dBm. Defaults to 10 dBm.
      \param preambleLength Preamble Length in bits. Defaults to 16 bits.
      \returns \ref status_codes
    */
    int16_t begin(float freq = RADIOLIB_CC1101_DEFAULT_FREQ, float br = RADIOLIB_CC1101_DEFAULT_BR,
                  float freqDev = RADIOLIB_CC1101_DEFAULT_FREQDEV, float rxBw = RADIOLIB_CC1101_DEFAULT_RXBW,
    ...
    /*!
      ...
      \returns \ref status_codes
    */
    int16_t beginFSK4(float freq = RADIOLIB_CC1101_DEFAULT_FREQ, float br = RADIOLIB_CC1101_DEFAULT_BR,
                      float freqDev = RADIOLIB_CC1101_DEFAULT_FREQDEV, float rxBw = RADIOLIB_CC1101_DEFAULT_RXBW,
                      int8_t pwr = RADIOLIB_CC1101_DEFAULT_POWER,
                      uint8_t preambleLength = RADIOLIB_CC1101_DEFAULT_PREAMBLELEN);

    /*!
      \brief Reset method - resets the chip using manual reset sequence (without
      RESET pin).
    */
    void reset();
    ...
    */
    ...
    /*!
      \brief Stops direct mode. It is required to call this method to switch from
      direct transmissions to packet-based transmissions.
    */
    int16_t packetMode();
    ...
    */
    ...
    /*!
      \brief Interrupt-driven binary transmit method for packets less than 64
      bytes. Method blocks for packets longer than 64 bytes up to a 255 byte
      limit, until the last bytes are placed in the FIFO. Some limitations and
      issues apply; see discussion:
    ...
    */
    ...
    /*!
      \brief Interrupt-driven receive method. GDO0 will be activated when full
      packet is received. \returns \ref status_codes
    */
    int16_t startReceive() override;

    /*!
      \brief Interrupt-driven receive method, implemented for compatibility with
      PhysicalLayer. \param timeout Ignored. \param irqFlags Ignored. \param
      irqMask Ignored. \param len Ignored. \returns \ref status_codes
    */
    ...
    /*!
      ...
      the packet length will be retreived automatically. When more bytes than
    ...
    */
    ...
    /*!
      \brief Sets carrier frequency. Allowed values are in bands 300.0 to 348.0
      MHz, 387.0 to 464.0 MHz and 779.0 to 928.0 MHz. \param freq Carrier
      frequency to be set in MHz. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Sets bit rate tolerance in BSCFG register. Allowed values are 0:(0%),
      1(3,125%), 2:(6,25%) and 3:(12,5%). \param brt Bit rate tolerance to be set.
      \returns \ref status_codes
    */
    int16_t setBitRateTolerance(uint8_t brt);

    /*!
      \brief Sets receiver bandwidth. Allowed values are 58, 68, 81, 102, 116,
      135, 162, 203, 232, 270, 325, 406, 464, 541, 650 and 812 kHz. \param rxBw
      Receiver bandwidth to be set in kHz. \returns \ref status_codes
    */
    int16_t setRxBandwidth(float rxBw);

    /*!
     \brief calculates and sets Rx bandwidth based on the freq, baud and freq
     uncertainty. Reimplement of atlas0fd00m's (RfCat) CalculatePktChanBw
     function. Modified for worse ppm with the CC1101, and adjusted for the
     supportted CC1101 bw. \returns \ref status_codes
    */
    int16_t autoSetRxBandwidth();

    /*!
      \brief Sets frequency deviation. Allowed values range from 1.587 to 380.8
      kHz. \param freqDev Frequency deviation to be set in kHz. \returns \ref
      status_codes
    */
    ...
    /*!
      ...
      \param[out] freqDev Pointer to variable where to save the frequency
      deviation. \returns \ref status_codes
    */
    int16_t getFrequencyDeviation(float *freqDev);

    /*!
      \brief Sets output power. Allowed values are -30, -20, -15, -10, 0, 5, 7 or
      10 dBm. \param pwr Output power to be set in dBm. \returns \ref status_codes
    */
    int16_t setOutputPower(int8_t pwr) override;

    /*!
      \brief Check if output power is configurable.
      This method is needed for compatibility with
      PhysicalLayer::checkOutputPower. \param power Output power in dBm. \param
      clipped Clipped output power value to what is possible within the module's
      range. \returns \ref status_codes
    */
    ...
    /*!
      ...
      \param clipped Clipped output power value to what is possible within the
      module's range. \param raw Raw internal value. \returns \ref status_codes
    */
    ...
    /*!
      ...
      \param len Sync word length in bytes. Maximum length depends on the module
      used. \returns \ref status_codes
    */
    ...
    /*!
      ...
      \param maxErrBits Maximum allowed number of bit errors in received sync
      word. Defaults to 0. \param requireCarrierSense Require carrier sense above
      threshold in addition to sync word. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param len Preamble length to be set (in bits), allowed values: 16, 24, 32,
      48, 64, 96, 128 and 192. \returns \ref status_codes
    */
    int16_t setPreambleLength(size_t len) override;

    /*!
      \brief Sets preamble length.
      \param preambleLength Preamble length to be set (in bits), allowed values:
      16, 24, 32, 48, 64, 96, 128 and 192. \param qualityThreshold Preamble
      quality threshold (PQT) to set. \returns \ref status_codes
    */
    int16_t setPreambleLength(uint8_t preambleLength, uint8_t qualityThreshold);

    /*!
      \brief Sets node and broadcast addresses. Calling this method will also
      enable address filtering. \param nodeAddr Node address to be set. \param
      numBroadcastAddrs Number of broadcast addresses to be used. Can be set to 0
      (no broadcast), 1 (broadcast at 0x00) or 2 (broadcast at 0x00 and 0xFF).
      \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      packet. In direct or asynchronous direct mode, returns the current RSSI
      level. \returns RSSI in dBm.
    */
    ...
    */
    ...
    /*!
      ...
      \param requireCarrierSense Require carrier sense above threshold in addition
      to sync word. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Set modem in "sniff" mode: no packet filtering (e.g., no preamble,
      sync word, address, CRC). \param enable Set or unset promiscuous mode.
      \param requireCarrierSense Set carriersense required above threshold,
      defaults to false. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      \brief Sets Gaussian filter bandwidth-time product that will be used for
      data shaping. Allowed value is RADIOLIB_SHAPING_0_5. Set to
      RADIOLIB_SHAPING_NONE to disable data shaping. \param sh Gaussian shaping
      bandwidth-time product that will be used for data shaping. \returns \ref
      status_codes
    */
    int16_t setDataShaping(uint8_t sh) override;

    /*!
      \brief Sets transmission encoding. Allowed values are RADIOLIB_ENCODING_NRZ,
      RADIOLIB_ENCODING_MANCHESTER, and RADIOLIB_ENCODING_WHITENING. Note that
      encoding on CC1101 is applied to the entire stream including preamble, sync
      word, and CRC. \param encoding Encoding to be used. \returns \ref
      status_codes
    */
    ...
    */
    ...
    /*!
      \brief Read version SPI register. Should return CC1101_VERSION_LEGACY (0x04)
      or CC1101_VERSION_CURRENT (0x14) if CC1101 is connected and working.
    ...
    */
    ...
    /*!
      ...
      receveid in direct mode. \param func Pointer to interrupt service routine.
    */
...
private:
    ...
    static void getExpMant(float target, uint16_t mantOffset, uint8_t divExp, uint8_t expMax, uint8_t &exp,
                           uint8_t &mant);
