...
#define RADIOLIB_LR11X0_STAT_1_CMD_DAT (0x03UL << 1)  //  3     1                     successfully processed, data is
//  being transmitted
...
#define RADIOLIB_LR11X0_ERROR_STAT_HF_XOSC_START_ERR                                                                   \
    (0x01UL << 5) //  15    0            high frequency oscillator failed to start
#define RADIOLIB_LR11X0_ERROR_STAT_LF_XOSC_START_ERR                                                                   \
    (0x01UL << 6) //  15    0            low frequency oscillator failed to start
...
#define RADIOLIB_LR11X0_IRQ_SYNC_WORD_HEADER_VALID                                                                     \
    (0x01UL << 5)                                      //  31    0                sync word or LoRa header valid
...
#define RADIOLIB_LR11X0_IRQ_FSK_LEN_ERROR                                                                              \
    (0x01UL << 24) //  31    0                FSK packet received with length error
#define RADIOLIB_LR11X0_IRQ_FSK_ADDR_ERROR                                                                             \
    (0x01UL << 25) //  31    0                FSK packet received with address error
#define RADIOLIB_LR11X0_IRQ_LORA_RX_TIMESTAMP (0x01UL << 27) //  31    0                last LoRa symbol was received
//  (timestamp source)
...
#define RADIOLIB_LR11X0_SLEEP_RETENTION_DISABLED                                                                       \
    (0x00UL << 0) //  0     0     configuration retention in sleep mode: disabled
#define RADIOLIB_LR11X0_SLEEP_RETENTION_ENABLED                                                                        \
    (0x01UL << 0) //  0     0                                            enabled
...
#define RADIOLIB_LR11X0_RX_TIMEOUT_INF (0xFFFFFFUL)  //  23    0                          infinite (Rx continuous
//  mode)
...
#define RADIOLIB_LR11X0_AUTO_INTERMEDIARY_MODE_STBY_XOSC                                                               \
    (0x02UL << 0)                                                //  1     0                        standby with XOSC
...
#define RADIOLIB_LR11X0_CAD_EXIT_MODE_RX                                                                               \
    (0x01UL << 0) //  7     0                            receive if activity detected
#define RADIOLIB_LR11X0_CAD_EXIT_MODE_LBT (0x10UL << 0) //  7     0                            transmit if no activity
//  detected
#define RADIOLIB_LR11X0_CAD_PARAM_DEFAULT (0xFFUL << 0) //  7     0     used by the CAD methods to specify default
//  parameter value
...
#define RADIOLIB_LR11X0_GFSK_SHAPING_RAISED_COSINE_BT_0_7                                                              \
    (0x16UL << 0)                                           //  7     0                     raised cosine, BT = 0.7
...
#define RADIOLIB_LR11X0_GFSK_ADDR_FILTER_NODE_BROADCAST                                                                \
    (0x02UL << 0) //  7     0                        node and broadcast address
...
#define RADIOLIB_LR11X0_GFSK_PACKET_LENGTH_VARIABLE_SX128X                                                             \
    (0x02UL << 0) //  7     0                    variable, SX128x 9-bit length encoding
...
#define RADIOLIB_LR11X0_FALLBACK_MODE_STBY_XOSC                                                                        \
    (0x02UL << 0)                                      //  1     0                                standby with XOSC
...
#define RADIOLIB_LR11X0_LR_FHSS_BLOCK_BITS                                                                             \
    (RADIOLIB_LR11X0_LR_FHSS_FRAG_BITS + RADIOLIB_LR11X0_LR_FHSS_BLOCK_PREAMBLE_BITS)
...
#define RADIOLIB_LR11X0_WIFI_ACQ_MODE_BEACON_PACKET                                                                    \
    (0x02UL << 0) //  7     0                             beacon and packet
...
#define RADIOLIB_LR11X0_WIFI_ABORT_ON_TIMEOUT_ENABLED                                                                  \
    (0x01UL << 0) //  7     0     abort scanning on preamble timeout: enabled
#define RADIOLIB_LR11X0_WIFI_ABORT_ON_TIMEOUT_DISABLED                                                                 \
    (0x00UL << 0)                                    //  7     0                                         disabled
...
#define RADIOLIB_LR11X0_GNSS_RES_PSEUDO_DOPPLER_ENABLED                                                                \
    (0x01UL << 0) //  0     0     GNSS results in NAV message: pseudo-range (in single
//  scan mode) or Doppler information (in multiple scan mode)
#define RADIOLIB_LR11X0_GNSS_RES_PSEUDO_DOPPLER_DISABLED                                                               \
    (0x00UL << 0) //  0     0                                  not included
#define RADIOLIB_LR11X0_GNSS_RES_DOPPLER_ENABLED                                                                       \
    (0x01UL << 1) //  1     1                                  Doppler information
#define RADIOLIB_LR11X0_GNSS_RES_DOPPLER_DISABLED                                                                      \
    (0x00UL << 1)                                           //  1     1                                  not included
...
#define RADIOLIB_LR11X0_GNSS_CONTEXT_ERR_ALMANAC_UPD                                                                   \
    (0x04UL << 0) //  7     4                 almanac update not allowed
...
#define RADIOLIB_LR11X0_GNSS_FETCH_TIME_OPT_TOW                                                                        \
    (0x00UL << 0) //  7     0     time fetch options: ToW only, requires WN to
//  demodulated beforehand
#define RADIOLIB_LR11X0_GNSS_FETCH_TIME_OPT_TOW_WN (0x01UL << 0) //  7     0                         ToW and WN
#define RADIOLIB_LR11X0_GNSS_FETCH_TIME_OPT_TOW_WN_ROLL                                                                \
    (0x02UL << 0) //  7     0                         ToW, WN and rollover

// RADIOLIB_LR11X0_CMD_GNSS_READ_DEMOD_STATUS
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_NOT_POSSIBLE                                                                 \
    (-21) //  7     0     GNSS demodulation status: not possible to demodulate
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_SAT_LOST (-20) //  7     0                               satellite lost
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_ALMANAC_DEMOD_ERROR                                                          \
    (-19) //  7     0                               almanac demodulation error
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_TOO_LATE                                                                     \
    (-18) //  7     0                               woke up after preamble
//  (demodulation started too late)
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_20_MS_FAIL                                                                   \
    (-17) //  7     0                               20ms real-time clock failed
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_WAKE_UP_FAIL                                                                 \
    (-16) //  7     0                               wake up sync failed
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_WN_INVALID                                                                   \
    (-15) //  7     0                               week number not validated
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_NO_ACTIVE_SAT                                                                \
    (-14) //  7     0                               no active satellite selected
//  in satellite list
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_SLEEP_TOO_LONG                                                               \
    (-13) //  7     0                               sleep time too long
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_TOW_INVALID                                                                  \
    (-12) //  7     0                               wrong time-of-week demodulated
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_PREAMBLE_INVALID                                                             \
    (-11) //  7     0                               preamble not validated
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_DISABLED (-10) //  7     0                               demodulator disabled
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_EXTR_FAILED                                                                  \
    (-9) //  7     0                               demodulator extraction failed
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_NO_BIT_CHANGE                                                                \
    (-8) //  7     0                               no bit change found during
//  demodulation start
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_NO_BIT_CHANGE_ADV                                                            \
    (-7) //  7     0                               no bit change found during
//  advanced scan
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_NO_SAT_FOUND                                                                 \
    (-6)                                                 //  7     0                               no satellites found
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_SYNC_LOST (-5) //  7     0                               word sync lost
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_PARITY_NOT_ENOUGH                                                            \
    (-3) //  7     0                               parity check fail (not enough)
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_PARITY_TOO_MANY                                                              \
    (-2) //  7     0                               parity check fail (too many)
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_NO_PARITY                                                                    \
    (-1) //  7     0                               parity check fail (no parity
//  found)
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_WORD_SYNC_NONE                                                               \
    (0) //  7     0                               word sync search not started
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_WORD_SYNC_POT                                                                \
    (1) //  7     0                               potential word sync found
...
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_WN_FOUND                                                                     \
    (4) //  7     0                               week number and time-of-week
//  found
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_ALM_FOUND_UNSAVED                                                            \
    (5) //  7     0                               almanac found but not saved
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_HALF_ALM_SAVED                                                               \
    (6) //  7     0                               half of almanac found and saved
#define RADIOLIB_LR11X0_GNSS_DEMOD_STATUS_FULL_ALM_SAVED                                                               \
    (7) //  7     0                               full almanac found and saved
#define RADIOLIB_LR11X0_GNSS_DEMOD_INFO_WORD_SYNC_FOUND                                                                \
    (0x01UL << 0) //  7     0     GNSS demodulation info: word synchronization found
#define RADIOLIB_LR11X0_GNSS_DEMOD_INFO_TOW_FOUND                                                                      \
    (0x01UL << 1) //  7     0                             time-of-week found
#define RADIOLIB_LR11X0_GNSS_DEMOD_INFO_WN_DEMODED                                                                     \
    (0x01UL << 2) //  7     0                             week number demodulated
#define RADIOLIB_LR11X0_GNSS_DEMOD_INFO_WN_FOUND (0x01UL << 3) //  7     0                             week number found
#define RADIOLIB_LR11X0_GNSS_DEMOD_INFO_SUBFRAME_1_FOUND                                                               \
    (0x01UL << 4) //  7     0                             subframe 1 found
#define RADIOLIB_LR11X0_GNSS_DEMOD_INFO_SUBFRAME_4_FOUND                                                               \
    (0x01UL << 5) //  7     0                             subframe 4 found
#define RADIOLIB_LR11X0_GNSS_DEMOD_INFO_SUBFRAME_5_FOUND                                                               \
    (0x01UL << 6) //  7     0                             subframe 5 found

// RADIOLIB_LR11X0_CMD_GNSS_READ_ALMANAC_STATUS
#define RADIOLIB_LR11X0_GNSS_ALMANAC_STATUS_UP_TO_DATE                                                                 \
    (0) //  7     0     GPS/BeiDou almanac status: all satellites up-to-date
#define RADIOLIB_LR11X0_GNSS_ALMANAC_STATUS_OUTDATED                                                                   \
    (1) //  7     0                                at least one satellite needs
//  update
...
#define RADIOLIB_LR11X0_GNSS_SOLVER_ERR_NOT_CONVERGED                                                                  \
    (2) //  7     0                               not converged on solution
#define RADIOLIB_LR11X0_GNSS_SOLVER_ERR_NOT_ENOUGH_SV                                                                  \
    (3)                                                //  7     0                               not enough satellites
...
#define RADIOLIB_LR11X0_GNSS_SOLVER_ERR_ALM_PART_OLD                                                                   \
    (6) //  7     0                               part of almanac too old or not
//  available
#define RADIOLIB_LR11X0_GNSS_SOLVER_ERR_INCONSISTENT                                                                   \
    (7) //  7     0                               not consistent with history (?)
...
#define RADIOLIB_LR11X0_CRYPTO_STATUS_INV_KEY_ID                                                                       \
    (0x03UL << 0) //  7     0                           key/parameter source or
//  destination ID error
#define RADIOLIB_LR11X0_CRYPTO_STATUS_BUF_SIZE                                                                         \
    (0x05UL << 0)                                         //  7     0                           data buffer size invalid
