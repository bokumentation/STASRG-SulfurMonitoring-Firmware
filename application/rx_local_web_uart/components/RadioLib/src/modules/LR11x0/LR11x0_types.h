...
struct LR11x0WifiResult_t {
    ...
    /*! \brief Data rate ID holding information about modulation and coding rate.
    ...
    /*! \brief Whether this signal was sent by an access point (true) or end
     * device (false) */
    bool ap;
...
/*!
  ...
  \brief Structure to save result of passive WiFi scan.
  This result saves additional information alongside that in
  LR11x0WifiResultFull_t. Only scans performed with
  RADIOLIB_LR11X0_WIFI_ACQ_MODE_FULL_BEACON acquisition mode can yield this
  result!
*/
struct LR11x0WifiResultExtended_t : public LR11x0WifiResultFull_t {
    ...
    /*! \brief Refer to IEEE Std 802.11, 2016, Part 11: Wireless LAN MAC and PHY
     * Spec. */
    uint16_t service;
...
/*!
  ...
  \brief Structure to report information about versions of the LR11x0 hardware
  and firmware.
*/
struct LR11x0VersionInfo_t {
...
/*!
  ...
  \brief Structure to save information about one constellation of the GNSS
  almanac.
*/
struct LR11x0GnssAlmanacStatusPart_t {
    int8_t status;
...
struct LR11x0GnssAlmanacStatus_t {
    ...
    /*! \brief Timestamp of when almanac status was retrieved - timeUntilSubframe
