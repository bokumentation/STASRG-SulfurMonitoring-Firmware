...
/*!
  \class SX1231
  \brief Control class for %SX1231 module. Overrides some methods from RF69 due
  to different register values.
*/
...
public:
    ...
    */
    virtual int16_t begin(float freq = 434.0, float br = 4.8, float freqDev = 5.0, float rxBw = 125.0,
