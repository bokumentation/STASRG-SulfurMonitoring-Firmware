...
int16_t SX1280::startRanging(bool master, uint32_t addr, const uint16_t calTable[3][6])
{
    ...
    uint16_t calTbl[3][6] = {{10299, 10271, 10244, 10242, 10230, 10246},
...
int32_t SX1280::getRangingResultCommon(bool filtered)
{
    ...
    // TODO: at the moment, filtered values do not work and just return huge
    // numbers the datasheet also isn't exactly clear on how to use the filtering
    ...
    // shifting everything by 8 bits more to the left will convert the result to
    // signed number
