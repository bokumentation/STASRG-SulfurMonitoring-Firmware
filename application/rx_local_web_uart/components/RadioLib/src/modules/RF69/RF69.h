...
#define RADIOLIB_RF69_LISTEN_ABORT 0b00100000  //  5     5   abort Listen mode (has to be set together with
//  RF69_LISTEN_OFF)
...
#define RADIOLIB_RF69_FSK_GAUSSIAN_1_0 0b00000001 //  1     0                       FSK modulation Gaussian filter,
//  BT = 1.0
#define RADIOLIB_RF69_FSK_GAUSSIAN_0_5 0b00000010 //  1     0                       FSK modulation Gaussian filter,
//  BT = 0.5
#define RADIOLIB_RF69_FSK_GAUSSIAN_0_3 0b00000011 //  1     0                       FSK modulation Gaussian filter,
//  BT = 0.3
#define RADIOLIB_RF69_OOK_FILTER_BR 0b00000001 //  1     0                       OOK modulation filter, f_cutoff =
//  BR
#define RADIOLIB_RF69_OOK_FILTER_2BR 0b00000010 //  1     0                       OOK modulation filter, f_cutoff =
//  2*BR
...
#define RADIOLIB_RF69_AFC_LOW_BETA_ON 0b00100000  //  5     5   improved AFC routine for signals with modulation
//  index less than 2
...
#define RADIOLIB_RF69_LISTEN_RES_IDLE_4_1_MS                                                                           \
    0b10000000 //  7     6                                        4.1 ms (default)
...
#define RADIOLIB_RF69_LISTEN_ACCEPT_ABOVE_RSSI_THRESH                                                                  \
    0b00000000 //  3     3   packet acceptance criteria: RSSI above threshold
#define RADIOLIB_RF69_LISTEN_ACCEPT_MATCH_SYNC_ADDRESS                                                                 \
    0b00001000 //  3     3                               RSSI above threshold AND
//  sync address matched
#define RADIOLIB_RF69_LISTEN_END_KEEP_RX 0b00000000 //  2     1   action after packet acceptance: stay in Rx mode
#define RADIOLIB_RF69_LISTEN_END_KEEP_RX_TIMEOUT                                                                       \
    0b00000010 //  2     1                                   stay in Rx mode until
//  timeout (default)
#define RADIOLIB_RF69_LISTEN_END_KEEP_RX_TIMEOUT_RESUME                                                                \
    0b00000100 //  2     1                                   stay in Rx mode until
//  timeout, Listen mode will resume
...
//  default)
#define RADIOLIB_RF69_RX_BW_MANT_16 0b00000000 //  4     3   Channel filter bandwidth FSK: RxBw =
//  F(XOSC)/(RxBwMant * 2^(RxBwExp + 2))
#define RADIOLIB_RF69_RX_BW_MANT_20 0b00001000 //  4     3                            OOK: RxBw =
//  F(XOSC)/(RxBwMant * 2^(RxBwExp + 3))
...
#define RADIOLIB_RF69_OOK_PEAK_THRESH_DEC_1_1_CHIP                                                                     \
    0b00000000 //  2     0   OOK demodulator step period: once per chip (default)
#define RADIOLIB_RF69_OOK_PEAK_THRESH_DEC_1_2_CHIP                                                                     \
    0b00000001 //  2     0                                once every 2 chips
#define RADIOLIB_RF69_OOK_PEAK_THRESH_DEC_1_4_CHIP                                                                     \
    0b00000010 //  2     0                                once every 4 chips
#define RADIOLIB_RF69_OOK_PEAK_THRESH_DEC_1_8_CHIP                                                                     \
    0b00000011 //  2     0                                once every 8 chips
#define RADIOLIB_RF69_OOK_PEAK_THRESH_DEC_2_1_CHIP                                                                     \
    0b00000100 //  2     0                                2 times per chip
#define RADIOLIB_RF69_OOK_PEAK_THRESH_DEC_4_1_CHIP                                                                     \
    0b00000101 //  2     0                                4 times per chip
#define RADIOLIB_RF69_OOK_PEAK_THRESH_DEC_8_1_CHIP                                                                     \
    0b00000110 //  2     0                                8 times per chip
#define RADIOLIB_RF69_OOK_PEAK_THRESH_DEC_16_1_CHIP                                                                    \
    0b00000111 //  2     0                                16 times per chip

// RADIOLIB_RF69_REG_OOK_AVG
#define RADIOLIB_RF69_OOK_AVG_THRESH_FILT_32_PI                                                                        \
    0b00000000 //  7     6   OOK average filter coefficient: chip rate / 32*pi
#define RADIOLIB_RF69_OOK_AVG_THRESH_FILT_8_PI 0b01000000 //  7     6                                   chip rate / 8*pi
#define RADIOLIB_RF69_OOK_AVG_THRESH_FILT_4_PI 0b10000000 //  7     6                                   chip rate / 4*pi
//  (default)
...
#define RADIOLIB_RF69_TIMEOUT_RSSI_THRESH 0xFF     //  7     0   timeout will occur if PayloadReady interrupt is not
//  received
...
#define RADIOLIB_RF69_FIFO_FILL_CONDITION_SYNC 0b00000000 //  6     6   FIFO fill condition: on SyncAddress interrupt
//  (default)
...
#define RADIOLIB_RF69_ENTER_COND_NONE 0b00000000 //  7     5   condition for entering intermediate mode: none,
//  AutoModes disabled (default)
#define RADIOLIB_RF69_ENTER_COND_FIFO_NOT_EMPTY 0b00100000 //  7     5 FifoNotEmpty rising edge
#define RADIOLIB_RF69_ENTER_COND_FIFO_LEVEL 0b01000000 //  7     5                                             FifoLevel
//  rising edge
#define RADIOLIB_RF69_ENTER_COND_CRC_OK 0b01100000 //  7     5                                             CrcOk
//  rising edge
#define RADIOLIB_RF69_ENTER_COND_PAYLOAD_READY 0b10000000 //  7     5 PayloadReady rising edge
#define RADIOLIB_RF69_ENTER_COND_SYNC_ADDRESS                                                                          \
    0b10100000 //  7     5                                             SyncAddress
//  rising edge
#define RADIOLIB_RF69_ENTER_COND_PACKET_SENT                                                                           \
    0b11000000 //  7     5                                             PacketSent
//  rising edge
#define RADIOLIB_RF69_ENTER_COND_FIFO_EMPTY 0b11100000 //  7     5 FifoNotEmpty falling edge
#define RADIOLIB_RF69_EXIT_COND_NONE 0b00000000        //  4     2   condition for exiting intermediate mode: none,
//  AutoModes disabled (default)
#define RADIOLIB_RF69_EXIT_COND_FIFO_EMPTY                                                                             \
    0b00100000 //  4     2                                            FifoNotEmpty
//  falling edge
#define RADIOLIB_RF69_EXIT_COND_FIFO_LEVEL 0b01000000 //  4     2                                            FifoLevel
//  rising edge
#define RADIOLIB_RF69_EXIT_COND_CRC_OK 0b01100000 //  4     2                                            CrcOk rising
//  edge
#define RADIOLIB_RF69_EXIT_COND_PAYLOAD_READY                                                                          \
    0b10000000 //  4     2                                            PayloadReady
//  rising edge
#define RADIOLIB_RF69_EXIT_COND_SYNC_ADDRESS                                                                           \
    0b10100000 //  4     2                                            SyncAddress
//  rising edge
#define RADIOLIB_RF69_EXIT_COND_PACKET_SENT 0b11000000 //  4     2                                            PacketSent
//  rising edge
#define RADIOLIB_RF69_EXIT_COND_TIMEOUT 0b11100000 //  4     2                                            timeout
//  rising edge
...
#define RADIOLIB_RF69_TX_START_CONDITION_FIFO_LEVEL                                                                    \
    0b00000000 //  7     7   packet transmission start condition: FifoLevel
#define RADIOLIB_RF69_TX_START_CONDITION_FIFO_NOT_EMPTY                                                                \
    0b10000000 //  7     7                                        FifoNotEmpty
//  (default)
...
#define RADIOLIB_RF69_INTER_PACKET_RX_DELAY                                                                            \
    0b00000000                                       //  7     4   delay between FIFO empty and start of new RSSI phase
...
#define RADIOLIB_RF69_AES_ON 0b00000001              //  0     0   AES encryption enabled, payload size limited to 66
//  bytes
...
#define RADIOLIB_RF69_CONTINUOUS_DAGC_LOW_BETA_ON                                                                      \
    0x20 //  7     0                              improved mode for AfcLowBetaOn
#define RADIOLIB_RF69_CONTINUOUS_DAGC_LOW_BETA_OFF                                                                     \
    0x30 //  7     0                              improved mode for AfcLowBetaOff
//  (default)
...
#define RADIOLIB_RF69_DEFAULT_SW                                                                                       \
    { 0x12, 0xAD }
...
public:
    ...
    */
    ...
    /*!
      ...
      to 5.0 kHz. \param rxBw Receiver bandwidth in kHz. Defaults to 125.0 kHz.
      \param pwr Output power in dBm. Defaults to 10 dBm.
      \param preambleLen Preamble Length in bits. Defaults to 16 bits.
      \returns \ref status_codes
    */
    int16_t begin(float freq = RADIOLIB_RF69_DEFAULT_FREQ, float br = RADIOLIB_RF69_DEFAULT_BR,
                  float freqDev = RADIOLIB_RF69_DEFAULT_FREQDEV, float rxBw = RADIOLIB_RF69_DEFAULT_RXBW,
                  int8_t pwr = RADIOLIB_RF69_DEFAULT_POWER, uint8_t preambleLen = RADIOLIB_RF69_DEFAULT_PREAMBLELEN);
    ...
    */
    ...
    /*!
      \brief Sets carrier frequency. Allowed values are in bands 290.0 to 340.0
      MHz, 431.0 to 510.0 MHz and 862.0 to 1020.0 MHz. \param freq Carrier
    ...
    */
    ...
    /*!
      \brief Sets receiver bandwidth. Allowed values
      are 2.6, 3.1, 3.9, 5.2, 6.3, 7.8, 10.4, 12.5, 15.6,
      20.8, 25.0, 31.3, 41.7, 50.0, 62.5, 83.3, 100.0, 125.0, 166.7, 200.0, 250.0,
      333.3, 400.0 and 500.0 kHz. \param rxBw Receiver bandwidth to be set in kHz.
      \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param[out] freqDev Where to write the frequency deviation currently set, in
      kHz. \returns \ref status_codes
    */
    ...
    /*!
      ...
      \param highPower Set to true when using modules high power port
      (RF69H/HC/HCW). Defaults to false (models without high power port -
      RF69C/CW). \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param preambleLen Preamble length to be set (in bits), allowed values: 16,
      24, 32, 48, 64, 96, 128 and 192. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      filtering for node and broadcast address. \param broadAddr Node address to
    ...
    */
    ...
    /*!
      \brief Sets ambient temperature. Required to correct values from on-board
      temperature sensor. \param tempAmbient Ambient temperature in degrees
      Celsius.
    */
    ...
    */
    ...
    /*!
      \brief Enables/disables OOK modulation instead of FSK.
       Note: This function calls setRxBandwidth again, since register values
      differ based on OOK mode being enabled/disabled. \param enable Enable (true)
      or disable (false) OOK. \returns \ref status_codes
    */
    int16_t setOOK(bool enable);

    /*!
      \brief Selects the type of threshold in the OOK data slicer
      \param type Threshold type: RADIOLIB_RF69_OOK_THRESH_PEAK(default),
      RADIOLIB_RF69_OOK_THRESH_FIXED or RADIOLIB_RF69_OOK_THRESH_AVERAGE \returns
      \ref status_codes
    */
    ...
    /*!
      ...
      for the Data Slicer in OOK when Peak mode is used. \param value Fixed
      threshold value (in dB) in the OOK demodulator. Used when OokThresType =
      RADIOLIB_RF69_OOK_THRESH_FIXED. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      data shaping. Allowed values are RADIOLIB_SHAPING_0_3, RADIOLIB_SHAPING_0_5
      or RADIOLIB_SHAPING_1_0. Set to RADIOLIB_SHAPING_NONE to disable data
      shaping. \param sh Gaussian shaping bandwidth-time product that will be used
      for data shaping \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      packet. \returns Last packet RSSI in dBm.
    */
    ...
    */
    ...
    /*!
      \brief Read version SPI register. Should return RF69_CHIP_VERSION (0x24) if
      SX127x is connected and working. \returns Version register contents or \ref
      status_codes
    */
