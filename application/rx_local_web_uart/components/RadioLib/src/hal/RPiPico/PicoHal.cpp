...
// we do this to save calculation time (see
// https://github.com/khoih-prog/RP2040_PWM/issues/6)
...
// === NOTE ===
// The tone(...) implementation uses the second core on the RPi Pico. This is to
// diminish as much jitter in the output tones as possible.
...
{
    // tones on the Pico are generated using bitbanging. This process is offloaded
    // to the Pico's second core
