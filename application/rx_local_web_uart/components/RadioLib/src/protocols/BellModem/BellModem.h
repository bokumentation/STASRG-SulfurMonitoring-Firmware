...
/*!
  \class BellClient
  \brief Client for Bell modem communication. The public interface is the same
  as Arduino Serial.
*/
...
public:
    ...
    */
    ...
    /*!
      ...
      communication. \param pin The GPIO pin at which the tones will be generated.
    */
    explicit BellClient(PhysicalLayer *phy, uint32_t pin);

    /*!
      \brief Audio-client constructor. Can be used when AFSKClient instance
      already exists. \param aud Audio client to use.
    */
