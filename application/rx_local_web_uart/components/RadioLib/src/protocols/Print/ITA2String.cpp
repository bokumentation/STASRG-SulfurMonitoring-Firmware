...
{
    // length returned by this method is different than the length of
    // ASCII-encoded strAscii ITA2-encoded string length varies based on how many
    // number and characters the string contains
