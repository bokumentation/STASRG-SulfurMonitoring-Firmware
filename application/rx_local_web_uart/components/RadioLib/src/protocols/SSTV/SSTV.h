...
struct tone_t {
    ...
    /*!
      \brief Tone type: GENERIC for sync and porch tones, SCAN_GREEN, SCAN_BLUE
      and SCAN_RED for scan lines.
    */
    enum { GENERIC = 0, SCAN_GREEN_Y, SCAN_BLUE_CB, SCAN_RED_CR } type;
...
struct SSTVMode_t {
    ...
    */
    ...
    /*!
      \brief Number of tones in each transmission line. Picture scan data is
      considered single tone.
    */
    uint8_t numTones;

    /*!
      \brief Sequence of tones in each transmission line. This is used to create
      the correct encoding sequence.
    */
    tone_t tones[9];
};
...
public:
    ...
    */
    ...
    /*!
      ...
      \param mode SSTV mode to be used. Currently supported modes are Scottie1,
      Scottie2, ScottieDX, Martin1, Martin2, Wrasse, PasokonP3, PasokonP5 and
      PasokonP7, Robot36 and Robot37. \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param correction Timing correction factor, used to adjust the length of
      timing pulses. Less than 1.0 leads to shorter timing pulses, defaults to 1.0
      (no correction). \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param imgLine Image line to send, in 24-bit RGB. It is up to the user to
      ensure that imgLine has enough pixels to send it in the current SSTV mode.
    */
