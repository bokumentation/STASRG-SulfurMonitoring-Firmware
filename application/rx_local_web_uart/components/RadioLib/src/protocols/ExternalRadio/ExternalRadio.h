...
public:
    ...
    /*!
      ...
      \param pin Output pin when using direct transmission, defaults to unused
      pin.
    */
    ...
    */
    ExternalRadio(RadioLibHal *hal,
                  uint32_t pin = RADIOLIB_NC); // cppcheck-suppress noExplicitConstructor
    ...
    */
    ...
    /*!
      ...
      \param frf "Frequency" to control the output pin. If the frequency is higher
      than the one sent previously, the output pin will be set to logic high.
      Otherwise it will be set to logic low. \returns \ref status_codes
    */
