...
/*!
  \class AFSKClient
  \brief Client for audio-based transmissions. Requires Arduino tone() function,
  and a module capable of direct mode transmission using DIO pins.
*/
class AFSKClient {
public:
    /*!
      ...
      communication. \param pin The pin that will be used for audio output.
    */
    ...
    */
    ...
    /*!
      ...
      \param autoStart Whether to automatically enter transmission mode. Defaults
      to true. \returns \ref status_codes
    */
    int16_t tone(uint16_t freq, bool autoStart = true);

    /*!
      \brief Stops transmitting audio tone.
      \param keepOn Keep transmitter on - this may limit noise when switching
      transmitter on or off. \returns \ref status_codes
    */
