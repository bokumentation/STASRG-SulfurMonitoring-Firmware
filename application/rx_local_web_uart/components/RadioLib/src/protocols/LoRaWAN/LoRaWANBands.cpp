...
const LoRaWANBand_t *LoRaWANBands[RADIOLIB_LORAWAN_NUM_SUPPORTED_BANDS] = {
    &EU868, &US915, &EU433, &AU915, &CN470, &AS923, &AS923_2, &AS923_3, &AS923_4, &KR920, &IN865,
};
...
const LoRaWANBand_t EU868 = {
    ...
    .rx1DrTable = {{0, 0, 0, 0, 0, 0, 0x0F, 0x0F},
    ...
    .dataRates = {{.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {12, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
...
const LoRaWANBand_t US915 = {
    ...
    .dwellTimeDn = 0,
    .txParamSupported = false,
    .txFreqs = {RADIOLIB_LORAWAN_CHANNEL_NONE, RADIOLIB_LORAWAN_CHANNEL_NONE, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .numTxSpans = 2,
    .txSpans =
    {   {.numChannels = 64, .freqStart = 9023000, .freqStep = 2000, .drMin = 0, .drMax = 3, .drJoinRequest = 0},
        {.numChannels = 8, .freqStart = 9030000, .freqStep = 16000, .drMin = 4, .drMax = 4, .drJoinRequest = 4}
    },
    .rx1Span = {
        .numChannels = 8,
        .freqStart = 9233000,
    ...
    .rx1DrTable = {{10, 9, 8, 8, 0x0F, 0x0F, 0x0F, 0x0F},
    ...
    .txWoR = {{.idx = 0, .freq = 9167000, .drMin = 10, .drMax = 10, .dr = 10},
        {.idx = 1, .freq = 9199000, .drMin = 10, .drMax = 10, .dr = 10}
    },
    .txAck = {{.idx = 0, .freq = 9183000, .drMin = 10, .drMax = 10, .dr = 10},
        {.idx = 1, .freq = 9215000, .drMin = 10, .drMax = 10, .dr = 10}
    },
    .dataRates = {{.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {10, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {9, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {8, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {7, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
...
const LoRaWANBand_t EU433 = {
    ...
    .txWoR = {RADIOLIB_LORAWAN_CHANNEL_NONE, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .txAck = {RADIOLIB_LORAWAN_CHANNEL_NONE, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .dataRates = {{.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {12, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {11, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {10, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {9, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
...
const LoRaWANBand_t AU915 = {
    ...
    .numTxSpans = 2,
    .txSpans =
    {   {.numChannels = 64, .freqStart = 9152000, .freqStep = 2000, .drMin = 0, .drMax = 5, .drJoinRequest = 2},
        {.numChannels = 8, .freqStart = 9159000, .freqStep = 16000, .drMin = 6, .drMax = 6, .drJoinRequest = 6}
    },
    .rx1Span = {
        .numChannels = 8,
        .freqStart = 9233000,
    ...
    .rx1DrTable = {{8, 8, 8, 8, 8, 8, 0x0F, 0x0F},
    ...
    .dataRates = {{.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {12, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
...
const LoRaWANBand_t CN470 = {
    ...
    .txFreqs = {RADIOLIB_LORAWAN_CHANNEL_NONE, RADIOLIB_LORAWAN_CHANNEL_NONE, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .numTxSpans = 1,
    .txSpans = {{.numChannels = 96, .freqStart = 4703000, .freqStep = 2000, .drMin = 0, .drMax = 5, .drJoinRequest = 3},
...
const LoRaWANBand_t AS923 = {
    ...
    .txParamSupported = true,
    .txFreqs = {{.idx = 0, .freq = 9232000, .drMin = 0, .drMax = 5, .dr = 3},
    ...
    .txSpans = {RADIOLIB_LORAWAN_CHANNEL_SPAN_NONE, RADIOLIB_LORAWAN_CHANNEL_SPAN_NONE},
    .rx1Span = RADIOLIB_LORAWAN_CHANNEL_SPAN_NONE,
    .rx1DrTable = {{0, 0, 0, 0, 0, 0, 1, 2}, // note:
    ...
    .txWoR = {{.idx = 0, .freq = 9236000, .drMin = 3, .drMax = 3, .dr = 3}, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .txAck = {{.idx = 0, .freq = 9238000, .drMin = 3, .drMax = 3, .dr = 3}, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .dataRates = {{.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {12, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {11, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {10, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {9, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
...
const LoRaWANBand_t AS923_2 = {
    ...
    .dwellTimeDn = RADIOLIB_LORAWAN_DWELL_TIME,
    .txParamSupported = true,
    .txFreqs = {{.idx = 0, .freq = 9214000, .drMin = 0, .drMax = 5, .dr = 3},
    ...
    .txWoR = {{.idx = 0, .freq = 9218000, .drMin = 3, .drMax = 3, .dr = 3}, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .txAck = {{.idx = 0, .freq = 9220000, .drMin = 3, .drMax = 3, .dr = 3}, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .dataRates = {{.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {12, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {11, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {10, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {9, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
...
const LoRaWANBand_t AS923_3 = {
    ...
    .dwellTimeDn = RADIOLIB_LORAWAN_DWELL_TIME,
    .txParamSupported = true,
    .txFreqs = {{.idx = 0, .freq = 9166000, .drMin = 0, .drMax = 5, .dr = 3},
    ...
    .txWoR = {{.idx = 0, .freq = 9170000, .drMin = 3, .drMax = 3, .dr = 3}, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .txAck = {{.idx = 0, .freq = 9172000, .drMin = 3, .drMax = 3, .dr = 3}, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .dataRates = {{.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {12, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {11, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {10, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {9, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
...
const LoRaWANBand_t AS923_4 = {
    ...
    .dwellTimeDn = RADIOLIB_LORAWAN_DWELL_TIME,
    .txParamSupported = true,
    .txFreqs = {{.idx = 0, .freq = 9173000, .drMin = 0, .drMax = 5, .dr = 3},
    ...
    .txWoR = {{.idx = 0, .freq = 9177000, .drMin = 3, .drMax = 3, .dr = 3}, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .txAck = {{.idx = 0, .freq = 9179000, .drMin = 3, .drMax = 3, .dr = 3}, RADIOLIB_LORAWAN_CHANNEL_NONE},
    .dataRates = {{.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {12, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {11, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {10, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {9, 125, 5}}, .pc = {.lora = {8, false, true, false}}},
...
const LoRaWANBand_t KR920 = {
    ...
    .dwellTimeDn = 0,
    .txParamSupported = false,
    .txFreqs = {{.idx = 0, .freq = 9221000, .drMin = 0, .drMax = 5, .dr = 3},
    ...
    .txWoR = {{.idx = 0, .freq = 9227000, .drMin = 3, .drMax = 3, .dr = 3},
        {.idx = 1, .freq = 9231000, .drMin = 3, .drMax = 3, .dr = 3}
    },
    .txAck = {{.idx = 0, .freq = 9229000, .drMin = 3, .drMax = 3, .dr = 3},
        {.idx = 1, .freq = 9231000, .drMin = 3, .drMax = 3, .dr = 3}
    },
    .dataRates = {{.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {12, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
        {.modem = RADIOLIB_MODEM_LORA, .dr = {.lora = {11, 125, 5}}, .pc = {.lora = {8, false, true, true}}},
...
const LoRaWANBand_t IN865 = {
    ...
    .dwellTimeDn = 0,
    .txParamSupported = false,
    .txFreqs = {{.idx = 0, .freq = 8650625, .drMin = 0, .drMax = 5, .dr = 3},
    ...
    .txWoR = {{.idx = 0, .freq = 8660000, .drMin = 3, .drMax = 3, .dr = 3},
        {.idx = 1, .freq = 8667000, .drMin = 3, .drMax = 3, .dr = 3}
    },
    .txAck = {{.idx = 0, .freq = 8662000, .drMin = 3, .drMax = 3, .dr = 3},
