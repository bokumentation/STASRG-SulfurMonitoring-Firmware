...
DateTime RTC_PCF8523::now()
{
    ...
    return DateTime(bcd2bin(buffer[6]) + 2000U, bcd2bin(buffer[5]), bcd2bin(buffer[3]), bcd2bin(buffer[2]),
                    bcd2bin(buffer[1]), bcd2bin(buffer[0] & 0x7F));
}
...
{
    write_register(PCF8523_CONTROL_1, read_register(PCF8523_CONTROL_1) | (1 << 5));
}
...
{
    write_register(PCF8523_CONTROL_1, read_register(PCF8523_CONTROL_1) & ~(1 << 2));
}
...
*/
/**************************************************************************/
void RTC_PCF8523::enableCountdownTimer(PCF8523TimerClockFreq clkFreq, uint8_t numPeriods, uint8_t lowPulseWidth)
{
...
*/
/**************************************************************************/
void RTC_PCF8523::enableCountdownTimer(PCF8523TimerClockFreq clkFreq, uint8_t numPeriods)
{
...
void RTC_PCF8523::disableCountdownTimer()
{
    ...
    write_register(PCF8523_CLKOUTCONTROL, ~1 & read_register(PCF8523_CLKOUTCONTROL));
}
